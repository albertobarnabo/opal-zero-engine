...
```bash
git clone https://github.com/albertobarnabo/opalzero-ui
cd opalzero-ui
npm install
npm run dev
```
...
Point the UI at your opalzero-server instance from the **Settings** drawer (gear icon, bottom-left), or set it at build time:
